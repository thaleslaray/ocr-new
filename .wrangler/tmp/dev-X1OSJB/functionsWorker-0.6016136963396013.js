...
// ../../../../.wrangler/tmp/pages-xxqRKT/functionsWorker-0.6016136963396013.mjs
...
async function onRequestPost(context) {
  ...
  try {
    ...
    console.log("\u{1F511} Client API Key present:", !!clientApiKey);
    console.log("\u{1F511} Env API Key present:", !!env.MISTRAL_API_KEY);
    console.log("\u{1F511} Using API Key:", apiKey ? `${apiKey.substring(0, 10)}...` : "NONE");
    if (!apiKey) {
      return new Response(JSON.stringify({
        error: "Chave da API Mistral n\xE3o configurada. Configure no frontend ou use o modo teste."
      }), {
        status: 400,
    ...
    console.log("\u{1F517} Step 2/3: Getting signed URL...");
    ...
    console.log(`\u{1F389} Total processing time: ${totalTime}ms`);
...
// ../../../../.nvm/versions/node/v22.8.0/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../.nvm/versions/node/v22.8.0/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-HaKlGJ/middleware-insertion-facade.js
...
// ../../../../.nvm/versions/node/v22.8.0/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-HaKlGJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6016136963396013.js.map
